...
def summarize_text(txt: str):
    ...
    create_sentences(segments, MIN_WORDS, MAX_WORDS)

    create_chunks(sentences, CHUNK_LENGTH, STRIDE)

    parse_title_summary_results(results)
    ...
    get_topics(title_similarity, num_topics=8, bonus_constant=0.25, min_size=3)

    ###------------------------------------------------------------------------------------------###

    summarize_stage_2(stage_1_outputs, topics, summary_num_words=250)
